const HORSES = [
	...
	},
	{
		...
		description: [
			...
			"Molt contents que dues families que es van fer amigues en una visita solidària a la Fundació, l’hagin apadrinat!! llarga vida al Cadí!"
		],
		totalImages: 3
	},
	{
	...
	},
	{
		...
		sponsored: true,
		sponsor: "Jan",
		snippet: "El Moreu és un pollí molt especial. Fill de la Picancel i del Yembé i net de la Bhangra. Ja veieu quina gran familia i quants vincles familiars té!  El Moreu ha tingu sort de néixer en un paradís de cavalls i que el Jan l’hagi apadrinat tant aviat! Moltes gràcies Jan. Segur que amb aquest cavall aprens un munt de coses que et serviràn per a tota la vida.",
		description: [
	...
	},
	{
		...
		description: [
			...
			"La seva padrina, la Claudia, fa molts anys que coneix al Calaf. Va ser una de les primeres “usuaries” que va venir a la fundació a fer “comunicació amb cavalls” i amb el temps es van fer molt amics. Per això estem tant contents que l’hagi apadrinat!",
			"Gràcies Claudia!"
		],
		totalImages: 1
	},
...
const DOGS = [
	...
	},
	{
		...
		description: [
			...
			"Molt contens que el Timur, un noi que el Thai va conèixer pels Campaments del 2015, l’hagi apadrinat! Són dos grans amics!"
		],
		totalImages: 2
	}
]
